            ...
            <div class="col-xl-10 col-lg-9">
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Registering Fees</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $year ?></td>
                                        <td class="font-weight-bolder"><?php echo "ACJ0761"; ?></td>
                                        <td><?php echo $used_new ?></td>
                                        <td><?php echo $date_registered ?></td>
                                        <td>
                                            <?php
                                            if ($amount_status === "rejected") {
                                                echo "<p class='text-danger'> $amount_status </p>";
                                            }elseif($amount_status === "responded") {
                                                echo "<p class='text-success'> $amount_status </p>";
                                            }
                                            else {
