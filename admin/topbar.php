...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand bg-gradient-success d-flex align-items-center justify-content-center" href="index.php">
            <div bg-gradient-warning class="sidebar-brand-icon">
                <!--                    <i class="fas fa-laugh-wink"></i>-->
                <img src="../img/coat.jpeg" class="rounded" width="100" height="70" alt="">
            </div>
        </a>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-white-600 small">Administration</span>
